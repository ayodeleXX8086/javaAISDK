...
//        var a = new TensorVector(new float[]{3.0f, 6, 7});
//        var b = new TensorVector(new float[][]{{3.0f, 4.0f, 5.0f}, {6.0f, 5.0f, 7.0f}, {10.0f, 11.0f, 12.0f}});
//        var x = a.multiply(b);
//        System.out.println(x);
//        x.backPropagate();
//        System.out.println("X gradient " + x.toStringGradient());
//        System.out.println("B gradient " + b.toStringGradient());
//        System.out.println("a gradient " + a.toStringGradient());

        float[] arrayA = {2.0f, 3.0f, 4.0f};
        TensorVector tensorA = new TensorVector(arrayA);

        float[][] arrayB = {{1.0f, 2.0f, 3.0f}, {4.0f, 5.0f, 6.0f}};
        TensorVector tensorB = new TensorVector(arrayB);

// Perform the addition (handles broadcasting internally)
        ITensor tensorC = tensorA.add(tensorB);

// Backpropagate
        tensorC.backPropagate();

// Access and print gradients
        System.out.println("Gradient of A: " + tensorA.toStringGradient());
        System.out.println("Gradient of B: " + tensorB.toStringGradient());
        System.out.println("Gradient of C: " + tensorC.toStringGradient());
    }
